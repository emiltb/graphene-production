...
```{r}
experiments %>% 
  transmute(name = name, m_graphene = 4, m_ultrasonic_wet = m_1g_wet * m_graphene, V_NMP = c(400, 320, 300, NA), m_flask = c(336.60, 277.28, 299.51, NA), comments = c("Flask + connector", "Flask + connector", "Flask only", NA), m_graphene = c(NA, NA, NA, NA), yield = c(NA, NA, NA, NA)) %>% 
